#!/usr/bin/env python
"""Google Calendar OAuth2 helper functions for generating client tokens.
...
CLIENT_ID = ('272909479265-n7l3vebpf1ndvbbo6pr6sct09ssp2lta.'
             'apps.googleusercontent.com')
CLIENT_SECRET = 'idvZbF9ZAlU0oEHALaYY3Vpe'
...
def get_credentials_path():
  cred_path = os.path.expanduser('~/.config/calendar/credentials')
  return cred_path
